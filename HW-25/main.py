...
# ismlar=["Akmal","Akbar","Axmed","Asxab","Abror"]
# sorov=input("Ismni kiriting: ")
# if sorov in ismlar:
#     ismlar.remove(sorov)
# else:
...
# mevalar = ["olma", "banan", "olma", "uzum", "banan", "olcha"]
# toza_royxat=[]
# for meva in mevalar:
#     if meva not in toza_royxat:
#         toza_royxat.append(meva)
# print(toza_royxat)
